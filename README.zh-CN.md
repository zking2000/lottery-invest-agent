...
- 同时支持定时推送和即时取号两种模式
- 开奖后约 1 小时自动对比，并继续发送下一期 5 组号码和购买截止时间
...
- `refresh-latest`: 开奖后刷新最新一期、自动对比上一期推荐，并继续发送下一期 5 组号码
...
- 开奖后跟进：`Asia/Shanghai` 时区下周二、周四、周日 `22:15`
...
- 开奖后流程还会继续发送下一期 `5组` 推荐，并附上最后购买截止时间
